...
if ( !is_admin()) {
	   ...
	   wp_register_script( 'jquery', get_template_directory_uri() . '/js/jquery-1.7.2.min.js', false);
	   ...
	   wp_register_script( 'lazyload', get_template_directory_uri() ."/js/lrscroll.js");
