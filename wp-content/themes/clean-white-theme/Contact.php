...
<div class="maim_pages">
  ...
  <div style="width:862px;height:274px;border:#ccc solid 1px;" id="dituContent"></div>
...
<script type="text/javascript">
   ...
   <div class="news_in2">
          <img class="contact_img" src="<?php bloginfo('template_url'); ?>/images/contact_in_22.gif" />
